...
namespace ECS.Function.Physical
{
    public class F_Y_AXIS_MOVE_TO_SETPOS : AbstractFunction
    {
        ...
        {
            double setPosition = DataManager.Instance.GET_DOUBLE_DATA(IoNameHelper.V_DBL_SET_Y_ABS_POSITION, out bool _);
            DataManager.Instance.SET_DOUBLE_DATA(IoNameHelper.IN_DBL_PMAC_Y_POSITION, setPosition);
        }
