...
namespace ECS.UI.ViewModel
{
    ...
    public class ViewModelLocator
    {
        ...
        static ViewModelLocator()
        {
            ...
            SimpleIoc.Default.Register<Visual3DMainViewModel>();
            SimpleIoc.Default.Register<AlarmHistoryViewModel>();
            SimpleIoc.Default.Register<IoDataDisplayViewModel>();
            ...
            SimpleIoc.Default.Register<ProcessEditorViewModel>();
        ...
        public IoDataDisplayViewModel IoDataDisplayViewModel
        {
            get { return ServiceLocator.Current.GetInstance<IoDataDisplayViewModel>(); }
        }
        ...
        public Visual3DMainViewModel Visual3DMainViewModel
        {
            get { return ServiceLocator.Current.GetInstance<Visual3DMainViewModel>(); }
        }
        ...
        {
            get { return ServiceLocator.Current.GetInstance<ProcessEditorViewModel>(); }
        }
