...
namespace ECS.Function.Physical
{
    ...
    {
        private const string IO_X_HOMMING_START = "oPMAC.iAxisX.Homming";
        private const string IO_X_HOMMING_COMPLETE = "iPMAC.iAxisX.IsHome";
        ...
        public override string Execute()
        {
            ...
            if (DataManager.Instance.SET_INT_DATA(IO_X_HOMMING_START, 1))
            {
                Thread.Sleep(1000);
                ...
                while (true)
                {
                    ...
                    else if (DataManager.Instance.GET_INT_DATA(IO_X_HOMMING_COMPLETE, out result) == 1)
                    {
        ...
        {
            DataManager.Instance.SET_INT_DATA(IO_X_HOMMING_COMPLETE, 1);
        }
        ...
        public override void PostExecute()
        {
            IsAbort = false;
            IsProcessing = false;
            DataManager.Instance.SET_INT_DATA(IO_X_HOMMING_START, 0);
        }
    }
}
