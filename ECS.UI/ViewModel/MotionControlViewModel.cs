...
namespace ECS.UI.ViewModel
{
    public class MotionControlViewModel : ViewModelBase
    {
        ...
        public double MoveDistance { get { return _MoveDistance; } set { _MoveDistance = Math.Abs(value); RaisePropertyChanged("MoveDistance"); } }
        ...
        private void ExecuteZAxisCheckedCommand()
        {
            ...
            ButtonJogPlusContent = "Z-DOWN";
            ButtonJogMinusContent = "Z-UP";
