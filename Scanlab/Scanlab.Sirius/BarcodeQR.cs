...
{
    /// <summary>barcode qr code entity</summary>
    public class BarcodeQR : IEntity, IMarkerable, IDrawable, ICloneable
    {
        private string name;
        ...
        private BarcodeQR.ErrorCorrectionLevel errorCorrection;
        private int version;
        ...
        [JsonIgnore]
        [Browsable(false)]
        public EType EntityType => EType.BarcodeQRCode;
        ...
        [System.ComponentModel.Description("에러 정정 복구율 (L:7%, M:15%, Q:25%, H:30%)")]
        public BarcodeQR.ErrorCorrectionLevel ErrorCorrection
        {
            get => this.errorCorrection;
            set
            {
                if (this.Owner != null && this.isLocked)
                    return;
        ...
        [Category("Data")]
        [DisplayName("Version")]
        [System.ComponentModel.Description("QR Version: 1~40 (0:Auto)")]
        public int Version
        {
            get => this.version;
            set
            {
                if (this.Owner != null && this.isLocked || (value < 0 || value > 40))
                    return;
                this.version = value;
                this.isRegen = true;
            }
        ...
        [Category("Data")]
        [DisplayName("Width")]
        [System.ComponentModel.Description("가로 폭 (mm)")]
        ...
        [Category("Data")]
        [DisplayName("Height")]
        [System.ComponentModel.Description("세로 높이 (mm)")]
        [TypeConverter(typeof(FloatTypeConverter))]
        public float Height
        {
            get => this.height;
        ...
        public BarcodeQR()
        {
            ...
            this.format = (BarcodeFormat)2048;
            this.errorCorrection = BarcodeQR.ErrorCorrectionLevel.Quality;
        ...
        public object Clone()
        {
            BarcodeQR barcodeQr = new BarcodeQR()
            {
                Name = this.Name,
            ...
            if (this.PatternGroup != null)
                barcodeQr.PatternGroup = this.PatternGroup.Clone() as Group;
            foreach (LwPolyline outline in this.outlineList)
                barcodeQr.outlineList.Add((LwPolyline)outline.Clone());
            barcodeQr.hatch = (Group)this.hatch.Clone();
            return (object)barcodeQr;
        }
        ...
        private void RegenVertextList()
        {
            ...
            ZXing.QrCode.Internal.ErrorCorrectionLevel errorCorrectionLevel = (ZXing.QrCode.Internal.ErrorCorrectionLevel)ZXing.QrCode.Internal.ErrorCorrectionLevel.Q;
            switch (this.errorCorrection)
            {
                case BarcodeQR.ErrorCorrectionLevel.Low:
                    errorCorrectionLevel = (ZXing.QrCode.Internal.ErrorCorrectionLevel)ZXing.QrCode.Internal.ErrorCorrectionLevel.L;
                    break;
                case BarcodeQR.ErrorCorrectionLevel.Medium:
                    errorCorrectionLevel = (ZXing.QrCode.Internal.ErrorCorrectionLevel)ZXing.QrCode.Internal.ErrorCorrectionLevel.M;
                    break;
                case BarcodeQR.ErrorCorrectionLevel.Quality:
                    errorCorrectionLevel = (ZXing.QrCode.Internal.ErrorCorrectionLevel)ZXing.QrCode.Internal.ErrorCorrectionLevel.Q;
                    break;
                case BarcodeQR.ErrorCorrectionLevel.High:
                    errorCorrectionLevel = (ZXing.QrCode.Internal.ErrorCorrectionLevel)ZXing.QrCode.Internal.ErrorCorrectionLevel.H;
                    break;
            }
            QrCodeEncodingOptions codeEncodingOptions1 = new QrCodeEncodingOptions();
            ((EncodingOptions)codeEncodingOptions1).Width = this.px;
            ((EncodingOptions)codeEncodingOptions1).Height = this.py;
            codeEncodingOptions1.DisableECI = true;
            codeEncodingOptions1.CharacterSet = "UTF-8";
            codeEncodingOptions1.ErrorCorrection = errorCorrectionLevel;
            ((EncodingOptions)codeEncodingOptions1).Margin = this.quiteZone;
            ((EncodingOptions)codeEncodingOptions1).PureBarcode = true;
            QrCodeEncodingOptions codeEncodingOptions2 = codeEncodingOptions1;
            if (this.version > 0)
                codeEncodingOptions2.QrVersion = new int?(this.version);
            ((BarcodeWriterGeneric)this.barcodeWriter).Options = (EncodingOptions)codeEncodingOptions2;
            ...
            {
                Logger.Log(Logger.Type.Error, ex, "fail to regen qr code : " + this.Data);
                int num = (int)MessageBox.Show(ex.Message ?? "", "QR Code Exception", MessageBoxButtons.OK, MessageBoxIcon.Hand);
            }
        }
