...
{
    /// <summary>VectorEndn 엔티티 객체</summary>
    [JsonObject]
    public class VectorEnd : IEntity, IMarkerable, ICloneable
    {
        ...
        [JsonIgnore]
        [Browsable(false)]
        public EType EntityType => EType.VectorEnd;
        ...
        public virtual object Clone() => (object)new VectorEnd()
        {
            Name = this.Name,
