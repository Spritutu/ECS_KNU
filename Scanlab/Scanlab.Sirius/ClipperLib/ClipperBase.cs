...
namespace Scanlab.Sirius.ClipperLib
{
    internal class ClipperBase
    {
        ...
        internal static bool SlopesEqual(IntPoint pt1, IntPoint pt2, IntPoint pt3, bool UseFullRange) => UseFullRange ? Int128.Int128Mul(pt1.Y - pt2.Y, pt2.X - pt3.X) == Int128.Int128Mul(pt1.X - pt2.X, pt2.Y - pt3.Y) : (pt1.Y - pt2.Y) * (pt2.X - pt3.X) - (pt1.X - pt2.X) * (pt2.Y - pt3.Y) == 0L;
            ...
            else
            {
                ...
                if (tedge1.Dx == -3.4E+38 && tedge1.Prev.OutIdx != -2)
                {
                    ...
                    while (tedge7.Next.Dx == -3.4E+38)
                        tedge7 = tedge7.Next;
                    if (tedge7.Next.Top.X == tedge1.Prev.Top.X || tedge7.Next.Top.X > tedge1.Prev.Top.X)
                        tedge1 = tedge7.Next;
                }
        ...
        internal bool LocalMinimaPending() => this.m_CurrentLM != null;
